...
public class NavigateClass {
	...
	public static void main(String[] args) {
		...
		// 5. In next line we are using getCurrentUrl method .This will give the current
		// url of the webpage
		...
		System.out.println("this is " + browserObject.getTitle() + " website");
		// 8. In next line we are using getCurrentUrl method .This will give the current
		// url of the webpage
		System.out.println("url is: " + browserObject.getCurrentUrl());
		// 9. Using navigate method we again move to next website
		...
		System.out.println("this is " + browserObject.getTitle() + " website");
		System.out.println("url is: " + browserObject.getCurrentUrl());
		// 11. Now we use back method again to navigate back to the first website that
		// is "https://www.facebook.com/"
		browserObject.navigate().back();
		// 12. Now we use forward method to move forward direction that is to
